...
export default function SiteFooter() {
  return (
    <footer style={{ background: "#F1EEEA", borderTop: "1px solid rgba(33,36,39,0.08)", padding: "20px 40px", flexShrink: 0 }}>
      <div style={{
        ...
        <div style={{ textAlign: "right" }}>
          ...
          <p style={{ fontSize: 11, color: "rgba(33,36,39,0.3)", margin: "6px 0 0" }}>© 2026 Quantio Global. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
