    ...
    <aside style={{width:208,background:"#1B3A5C",display:"flex",flexDirection:"column",flexShrink:0,overflow:"hidden"}}>
      <div style={{padding:"16px 14px 12px",borderBottom:"1px solid rgba(255,255,255,.06)"}}>
        <div style={{display:"flex",alignItems:"center",gap:9}}>
          ...
          <div>
            <div style={{fontSize:13,fontWeight:800,color:"#F1F5F9",letterSpacing:-.3}}>FraudGuard</div>
            <div style={{fontSize:9,color:"#475569",fontWeight:600,letterSpacing:.5}}>GRANT INTELLIGENCE</div>
          </div>
        </div>
      </div>
      <nav style={{flex:1,padding:"10px 8px",overflowY:"auto"}}>
        {["main","sys"].map(grp=>(
          <div key={grp} style={{marginBottom:6}}>
            <div style={{fontSize:9,fontWeight:700,color:"#334155",letterSpacing:1,padding:"5px 10px 3px",textTransform:"uppercase"}}>{grp==="main"?"Workspace":"System"}</div>
      ...
      <div style={{padding:"8px 14px",borderTop:"1px solid rgba(255,255,255,.05)",fontSize:9,color:"#334155",fontWeight:600}}>v4.1 Enterprise · DS1-DS6 · OMB 2 CFR 200</div>
    </aside>
  );
}