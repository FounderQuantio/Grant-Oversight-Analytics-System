  ...
  return (
    <div style={{height:55,background:DS.surface,borderBottom:`1px solid ${DS.bd}`,display:"flex",alignItems:"center",padding:"0 22px",gap:16,flexShrink:0,zIndex:100}}>
      <button
        onClick={() => navigate("/")}
        title="Back to Home"
        style={{background:"rgba(171,171,171,0.08)",border:"1px solid rgba(171,171,171,0.25)",borderRadius:DS.r2,padding:"5px 12px",cursor:"pointer",color:"#ABABAB",fontSize:12,fontWeight:700,display:"flex",alignItems:"center",gap:5,flexShrink:0,transition:"all 0.15s"}}
        onMouseEnter={e=>{e.currentTarget.style.background="rgba(171,171,171,0.16)";e.currentTarget.style.borderColor="rgba(171,171,171,0.45)";}}
        onMouseLeave={e=>{e.currentTarget.style.background="rgba(171,171,171,0.08)";e.currentTarget.style.borderColor="rgba(171,171,171,0.25)";}}
      >
        ← Home
      </button>
